...
global.GetAllObjects = function () {
	return global.msgpack_unpack(_in(0x00000000, 0x6886c3fe, _r, _ro));
};
...
global.GetAllPeds = function () {
	return global.msgpack_unpack(_in(0x00000000, 0xb8584fef, _r, _ro));
};
 ...
 */
global.GetLastPedInVehicleSeat = function (vehicle, index) {
	return _in(0x00000000, 0xf7c6792d, vehicle, index, _r, _ri);
};
 ...
 */
global.GetPedInVehicleSeat = function (vehicle, index) {
	return _in(0x00000000, 0x388fde9a, vehicle, index, _r, _ri);
};
