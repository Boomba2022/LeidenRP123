...
Config.CarZones = {
	policeCarGarage = {
		Pos = {
			--{x = -1115.01, y = -834.98, z = 13.34},
			--{x = -1077.13, y = -846.32, z = 4.88},
			{x = 1853.57, y = 3676.1, z = 33.28},
			{x = 1850.51, y = 3674.58, z = 32.2},
			{x = 453.93, y = -1024.62, z = 28.55},
			{x = -458.2, y = 6005.51, z = 31.34},
			{x = -455.48, y = 6001.92, z = 31.34},
			{x = -452.24, y = 5998.48, z = 31.34},
			{x = -448.55, y = 5994.6, z = 31.34},
			{x = -462.86, y = 6009.86, z = 31.34},
			{x = -482.22, y = 6024.59, z = 31.34},
			{x = -479.2, y = 6027.77, z = 31.34},
			{x = -475.4, y = 6031.03, z = 31.34},
		}
	}
}
...
Config.HeliZones = {
	policeHeliGarage = {
		Pos = {
			{x = -1096.19,  y = -832.27, z = 37.7},
			{x = 449.35,  y = -981.4, z = 43.69},
			{x = -475.48, y = 5988.69, z = 31.34},
...
Config.policeVehicles = {
	{ model = '', label = '=============Politie=============='},
	    { model = 'pol1', label = 'Volkswagen Touran'},
		{ model = 'pol2', label = 'Mercedes B Klasse'},
		{ model = 'pol3', label = 'Mercedes B Klasse 2019'},
		{ model = 'pol4', label = 'Mercedes Vito'},
		{ model = 'pol5', label = 'Volkswagen T6'},
		{ model = 'pol6', label = 'Mercedes T6 BikeTeam'},
		{ model = 'pol7', label = 'Volkswagen Amarok'},
		{ model = 'pol8', label = 'Hyundai Kona'},
		{ model = 'pol9', label = 'Volkswagen Touran Hondengeleider'},
		{ model = 'pol10', label = 'Volkswagen Touraeg'},
		{ model = 'pol11', label = 'Volkswagen Passaat'},
		{ model = 'pol12', label = 'Volvo V70'},
		{ model = 'pol13', label = 'Audi A6'},
		{ model = 'pol14', label = 'Lichte motor'},
		{ model = 'pol15', label = 'Zware motor'},
		{ model = 'pol16', label = 'Verkeers technisch motor'},
		{ model = '', label = '=============Unmarked=============='},
		{ model = 'pol17', label = 'Volkswagen Polo Unmarked'},
		{ model = 'pol18', label = 'BMW 540I Unmarked'},
		{ model = 'pol19', label = 'Audi RS6 Unmarked'},
		{ model = 'pol20', label = 'Volvo V70 Wit'},
		{ model = 'pol21', label = 'Skoda Sedan Unmarked'},
		{ model = '', label = '=============Rest=============='},
		{ model = 'pol22', label = 'ME FlexBus'},
		{ model = 'pol23', label = 'Volkswagen Crafter'},
		{ model = 'pol24', label = 'T6 VOA'},
		{ model = 'pol25', label = 'Volvo XC90 OVD-P'},
	}
