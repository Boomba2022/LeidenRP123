...
-- ambulance Boat Garage Blip Settings:
...
-- ambulance Extra Menu Blip Settings:
...
-- ambulance Extra Garage Marker Settings:
...
Config.ExtraDraw3DText = "Press ~g~[E]~s~ for ~y~ambulance Extra Menu~s~"		-- set your desired text here

-- ambulance Cars:
Config.ambulanceVehicles = {
	{ model = '', label = '===========Amburlance============='},
		{ model = 'a1', label = 'Ambulance E klasse'},
		{ model = 'a3', label = 'AAmbulance MAN TGE'},
		{ model = 'a4', label = 'Ambulance Touran'},	
		{ model = 'a5', label = 'Ambulance Sprinter 2019'},
		{ model = 'a6', label = 'Ambulance XC40'},
		{ model = 'a9', label = 'Ambulance motor'},
	}
...
Config.ambulanceBoats = {
	--{ model = 'predator', label = 'ambulance Predator', livery = 0, price = 0 }
}
...
Config.TitleambulanceGarage = "Ambulance Garage"
Config.TitleambulanceExtra = "Extra"
Config.TitleambulanceLivery = "Kleurstelling"
...
Config.CarOutFromPolGar = "Je hebt een ~b~auto~s~ uit~y~ de ambulance Garage~s~ genomen!"
Config.HeliOutFromPolGar = "Je haalde een ~b~Helicopter~s~uit ~y~ambulance Heli Garage~s~!"
Config.BoatOutFromPolGar = "Je haalde een ~b~boot~s~ uit ~y~ambulance boot garage~s~!"
...
-- ambulance Extra Menu Positions:
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
