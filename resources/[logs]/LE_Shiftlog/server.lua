...
local http = "https://discord.com/api/webhooks/837607325144842240/KbRZkVESKK7bptSBvba2C5XCSZwAh5lOG0952_l6KpBD2xAkONzppyhErTghBBSsoU9d" -- webhook for police
local http2 = "https://discord.com/api/webhooks/837607325144842240/KbRZkVESKK7bptSBvba2C5XCSZwAh5lOG0952_l6KpBD2xAkONzppyhErTghBBSsoU9d" -- webhook for ems (you can add as many as you want)
local avatar = "https://cdn.discordapp.com/attachments/836731038050680832/837594626428370944/ddfgdfsfds_1.png" -- bot's avatar
    ...
    for k, v in pairs(timers) do
        for n = 1, #timers[k], 1 do
            if timers[k][n].id == id then
                ...
                if k == "police" then
                    header = "Politie dienst"
                    color = 3447003
                elseif k == "ambulance" then
                    header = "Ambulance dienst"
                    color = 15158332
                end
                if duration > 0 and duration < 60 then
                    timetext = tostring(math.floor(duration)).." seconds"
