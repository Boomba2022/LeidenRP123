...
AddEventHandler("playerConnecting", function(name, setReason, deferrals)
	SinglePlayerLogs('**' ..GetPlayerName(source).. '** Is aan het verbinden met de server', Config.BaseColors['joins'], source, 'joins')
end)

-- Send message when Player disconnects from the server
AddEventHandler('playerDropped', function(reason)
	SinglePlayerLogs('**' ..GetPlayerName(source).. '** Verlaat de server. (Reden: ' .. reason .. ')', Config.BaseColors['leaving'], source, 'leaving')
end)
...
AddEventHandler('playerShotWeapon', function(weapon)
	...
	if Config.weaponLog then
		SinglePlayerLogs('**' .. GetPlayerName(source)  .. '** Loste een schot `' .. weapon .. '`', Config.BaseColors['shooting'], source, 'shooting')
    end
end)
