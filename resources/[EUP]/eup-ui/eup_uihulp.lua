...
local mainMenu = NativeUI.CreateMenu('Hulpverleners EUP', 'Kies je afdeling')
...
menuPool:RefreshIndex()
    ...
    RegisterCommand('ambulance', function()
        ...
        if PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'ambulance' then
