      ...
      if IsControlPressed(0, Keys['E']) then
        if CurrentAction == 'ambulance_duty' then
          ...
          if PlayerData.job.name == 'ambulance' then
            exports['B1G_NOTIFY']:Notify('false', 'Je bent nu uitdienst')
            Wait(1000)
          else
            exports['B1G_NOTIFY']:Notify('true', 'Je bent nu indienst')
            Wait(1000)
          end
        else
          exports['B1G_NOTIFY']:Notify('false', 'Je staat niet op de personeelslijst')
