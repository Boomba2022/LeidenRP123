...
Config.Languages = {
    ['en'] = {
        ["NO_VEHICLE"] = "Geen voertuig in de buurt",
        ["NO_ONE"] = "Niemand in de buurt",
        ["ALLFIELDS"] = "Er moet iets ingevuld worden",

        ["RACE_TITLE"] = "Racen",

        ["WHATSAPP_TITLE"] = "Whatsapp",
        ["WHATSAPP_NEW_MESSAGE"] = "Nieuw bericht van",
        ["WHATSAPP_MESSAGE_TOYOU"] = "Waarom stuur je een bericht naar je zelf?",
        ["WHATSAPP_LOCATION_SET"] = "GPS is gezet",
        ["WHATSAPP_SHARED_LOCATION"] = "Gedeelde locatie",
        ["WHATSAPP_BLANK_MSG"] = "Je kan niet niks sturen",

        ["MAIL_TITLE"] = "Mail",
        ["MAIL_NEW"] = "Je hebt een e-mail verzonden ",

        ["ADVERTISEMENT_TITLE"] = "Advertentie",
        ["ADVERTISEMENT_NEW"] = "Er is een advertentie geplaatst",
        ["ADVERTISEMENT_EMPY"] = "Je moet een bericht typen",

        ["TWITTER_TITLE"] = "Twitter",
        ["TWITTER_NEW"] = "Nieuwe Tweet",
        ["TWITTER_POSTED"] = "De tweet is gepost",
