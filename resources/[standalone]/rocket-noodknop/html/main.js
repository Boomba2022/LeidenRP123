$('document').ready(function() {
    ...
    function CreateNotification(data) {
        ...
        <div id="marker"><i class="'+ data.info["icon"] +'" aria-hidden="true"></i></div>\
        <div id="alert-info"><i class="fas fa-globe-europe"></i>' + data.info["loc"] + '<br>Druk op INSERT om deze locatie in te stellen.</div>\
        </div>');
        $notification.fadeIn();
