...
Config.Strings = {
	ExitVehicle = "Stap uit het voertuig om te tanken",
	EToRefuel = "Druk op ~g~E ~w~om te tanken",
	JerryCanEmpty = "Jerrycan is leeg",
	FullTank = "Tank is vol",
	PurchaseJerryCan = "Druk op ~g~E ~w~om een jerrycan te kopen voor ~g~€" .. Config.JerryCanCost,
	CancelFuelingPump = "Druk op ~g~E ~w~om het tanken te stoppen",
	CancelFuelingJerryCan = "Druk op ~g~E ~w~om het vullen te stoppen",
	NotEnoughCash = "Niet genoeg geld",
	RefillJerryCan = "Druk op ~g~E ~w~ om de jerrycan te vullen voor ",
	NotEnoughCashJerryCan = "Niet genog geld om de jerrycan te vullen",
	JerryCanFull = "Jerrycan is vol"
}
