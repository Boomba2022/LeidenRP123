...
repairCfg = {
	...
	fixMessages = {
		"Je hebt de carter stop terug gedraait",
		"Je hebt de olie lek met kauwgum gefixed",
		"Je hebt de olieleiding gefixed met tape",
		"Je hebt de carterstop aangedraaid omde olielek te stoppen",
		"Je schopte je motor en het kwam magisch weer tot leven",
		"Je hebt roest van de bougies verwijderd",
		"Je schreeuwde naar je voertuig en het had effect"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Je hebt je oliestop gechecked, het leek goed",
		"Je keek naar je motor, het leek goed",
		"Je bekeek of de tape het nog hield, en het hield nog",
		"Je hebt de radio volume omhoog gezet, Om het ratel geluid te dempen",
		"Je hebt roest-stop op je bougies gesprayed, het had geen effect",
		"Maak nooit iets wat niet kapot is."
	},
	noFixMessageCount = 6
}
