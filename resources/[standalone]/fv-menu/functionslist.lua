...
RegisterNetEvent('rollstuhl')
AddEventHandler('rollstuhl', function()
...
RegisterNetEvent('rollstuhlentfernen')
AddEventHandler('rollstuhlentfernen', function()
...
RegisterNetEvent('bahre')
AddEventHandler('bahre', function()
LoadModel('v_med_bed1')
	local wheelchair = CreateObject(GetHashKey('v_med_bed1'), GetEntityCoords(PlayerPedId()), true)
	end)
RegisterNetEvent('bahreentfernen')
AddEventHandler('bahreentfernen', function()
