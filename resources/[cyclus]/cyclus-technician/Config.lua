Cyclus = {
    Locker = {X= 135.11, Y= 322.98, Z= 116.63}, 

    Garage = {X= 149.61, Y= 322.11, Z= 112.14}, 
    VehicleSpawn = {X= 137.37, Y= 316.21, Z= 112.14, Heading= 115.0}, 
    VehicleDelete = {X= 143.01, Y= 309.20, Z= 112.13}, 
    Vehicles = { 
        {Name= "Pedo Busje", SpawnName= "speedo4"},
    },
    LicensePlate = "Cyclus", 

    BlipName = "Elektricien", 
    JobBlipName = "Klant", 
    ...
    TranslationList = { 
        ["NL"] = {
            ...
            ["GARAGE_PROBLEM"] = "Er is iets fout gegaan tijdens het spawnen van het voertuig. (Gestopt om een crash te voorkomen!)",
            ...
            ["MENU_CREATED"] = "Succesvol een nieuw opdracht gemaakt!",
            ["MENU_CANCEL"] = "Beëindig huidige opdracht",
            ["MENU_CANCELED"] = "Opdracht succesvol beëindigd!",
            ["MENU_ALREADY"] = "U bent nog bezig met een opdracht! U moet deze eerst beëindigen.",
            ["MENU_NONE"] = "U heeft geen huidige opdracht!",

            ["JOB_HELP"] = "Druk op ~INPUT_CONTEXT~ om een kijkje te nemen!",
            ["JOB_DONE"] = "Het probleem is succesvol op gelost. Je hebt er €100, voor gekregen!"
        }
    }
}