	...
	ESX.TriggerServerCallback('esx_vehiclelock:requestPlayerCars', function(isOwnedVehicle)
		...
		if isOwnedVehicle then
			...
			if lockStatus == 1 then -- locked
			 ...
			 VERANDEREN	--TriggerClientEvent('rocket-notify:grootnotify',  'Auto Sleutel', 'Je hebt je voertuig vergrendeld', 'fas fa-car', '5000', '#009286', true)
			...
			-- VERANDEREN	TriggerClientEvent('rocket-notify:grootnotify',  'Auto Sleutel', 'Je hebt je voertuig ontgrendeld', 'fas fa-car', '5000', '#009286', true)
				if not IsPedInAnyVehicle(PlayerPedId(), true) then
					TaskPlayAnim(PlayerPedId(), dict, "fob_click_fp", 8.0, 8.0, -1, 48, 1, false, false, false)
				end
				SetVehicleLights(vehicle, 2)
