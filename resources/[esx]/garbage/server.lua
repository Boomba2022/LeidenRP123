...
local dumpsterItems = {
    [1] = {chance = 7, id = 'thermal_charge', name = 'Thermal Charge', quantity = math.random(1,3), limit = 10},
    [2] = {chance = 4, id = 'h_laptop', name = 'Hacking Laptop', quantity = 1, limit = 4},
    [3] = {chance = 4, id = 'id_card', name = 'ID Kaart', quantity = 1, limit = 10},
    [4] = {chance = 3, id = 'lockpick', name = 'LockPick', quantity = 1, limit = 10},
    [5] = {chance = 2, id = 'knife', name = 'mes', quantity = math.random(1,8), limit = 0},
    [6] = {chance = 9, id = 'water', name = 'water', quantity = 1, limit = 2},
    [7] = {chance = 5, id = 'fixkit', name = 'Reparatie Kit', quantity = math.random(1,2), limit = 0},
    [8] = {chance = 7, id = 'coke', name = 'coke', quantity = 14, limit = 0},
    [9] = {chance = 1, id = 'molotov', name = 'Molotov', quantity = 1, limit = 0},
   }
