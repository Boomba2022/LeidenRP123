...
local formatOfMessage = '<div style="padding: 0.5vw; margin: 0.5vw; background-color: rgba(255, 0, 0, 0.6); border-radius: 3px;"><i class="fas fa-commenting"></i> <b><font color=white>[{0}]:</b></font> {1}</div>'
local usergroup = 'steam'
