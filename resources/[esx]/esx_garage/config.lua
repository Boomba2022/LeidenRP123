...
Config.Price		= 400 -- pound price to get vehicle back
...
Config.Garages = {
	UWV = {
		Pos = {x=-285.85, y=-888.62, z=31.20},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Druk op ~INPUT_PICKUP~ om de garage te openen",
		SpawnPoint = {
			Pos = {x=-284.50, y= -904.85, z= 31.20},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw voertuig te pakken"
		},
		DeletePoint = {
			Pos = {x=-290.35, y= -892.10, z= 31.20},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw voertuig te parkeren"
		}, 	
	},
	Theater = {
...
Config.GaragesMecano = {
	Bennys = {
		...
		SpawnPoint = {
			...
			Heading = 303.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om het voertuig uit de anwb garage te halen"
		},
		DeletePoint = {
			Pos = {x = 459.733,y = -1890.335,z = 25.776},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om het voertuig in de anwb garage te zetten"
		}, 	
	},
	police = {
		Name = 'Externe garage',
...
Config.BoatGarages = {
	Haven = {
		...
		SpawnPoint = {
			...
			Heading = 230.0,
			Marker = { w= 0.9, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw vaartuig uit de garage te halen"
		},
		DeletePoint = {
			Pos = {x = -740.06408691406,y = -1361.8474121094,z = 0.8801808655262 },
			Marker = { w= 3.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw vaartuig in de garage te zetten"
		}, 	
	},
}
...
Config.AirplaneGarages = {
	Vliegveld = {
		Pos = {x = -1280.1153564453,y = -3378.1647949219,z = 14.040155029297 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Druk op ~INPUT_PICKUP~ om de garage te openen",
		SpawnPoint = {
			Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 14.040155029297 },
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw vliegtuig uit de garage te halen"
		},
		DeletePoint = {
			Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 14.040155029297 },
			Marker = { w= 3.5, h= 2.0,r=255,g=0,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw vliegtuig in de garage te zetten"
		}, 	
	},
	Sandy = {
		Pos = {x = 1743.95,y = 3301.75,z = 41.30 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Druk op ~INPUT_PICKUP~ om de garage te openen",
		SpawnPoint = {
			Pos = {x = 1736.65,y = 3290.75,z = 41.30 },
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw vliegtuig uit de garage te halen"
		},
		DeletePoint = {
			Pos = {x = 1749.00,y = 3293.85,z = 41.30 },
			Marker = { w= 3.5, h= 2.0,r=255,g=0,b=0},
			HelpPrompt = "Druk op ~INPUT_PICKUP~ om uw vliegtuig in de garage te zetten"
		}, 	
	},
